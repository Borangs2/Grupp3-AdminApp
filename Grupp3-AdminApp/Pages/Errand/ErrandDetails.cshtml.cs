...
public class ErrandDetailsModel : PageModel
{
    ...
    public ErrandDetailsModel(IErrandService errandService, IElevatorService elevatorService,
    ...
    [BindProperty] public Guid ChosenSelectTechnician { get; set; }
    ...
    public async Task<IActionResult> OnPostDeleteErrand(string elevatorId, string errandId)
    {
        ...
        if (result == HttpStatusCode.OK)
            return RedirectToPage("/Elevator/ElevatorDetails", new {elevatorId});
        return Page();
    }
}